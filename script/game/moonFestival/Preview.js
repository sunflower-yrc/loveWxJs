...
var Preview = function () {
    var _classDecorators = [ccclass('Preview')];
    ...
    var Preview = _classThis = /** @class */ (function (_super) {
        __extends(Preview_1, _super);
        function Preview_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.roleNode = (__runInitializers(_this, _instanceExtraInitializers), __runInitializers(_this, _roleNode_initializers, null));
            _this.furnitureNode = __runInitializers(_this, _furnitureNode_initializers, null);
            return _this;
        }
        Preview_1.prototype.start = function () {
            this.setUI();
        };
        Preview_1.prototype.setUI = function () {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function () {
                var dropData, data, suit, data, suit;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            dropData = DropMgr_1.DropMgr.getDropData(this.data);
                            if (!(dropData[0].type == DataObject_1.DropType.Dress)) return [3 /*break*/, 2];
                            //服装
                            this.roleNode.active = true;
                            this.furnitureNode.active = false;
                            data = new DressData_1.DressData(dropData[0].dropId);
                            suit = new SuitData_1.SuitData(data.dressSuit);
                            return [4 /*yield*/, ((_a = this.roleNode.getComponent(Role_1.Role)) === null || _a === void 0 ? void 0 : _a.showSuitSkin(suit.suitShow))];
                        case 1:
                            _c.sent();
                            (_b = this.roleNode.getComponent(Role_1.Role)) === null || _b === void 0 ? void 0 : _b.changeAnim(DataObject_1.RoleAnimType.StandIdle);
                            return [3 /*break*/, 3];
                        case 2:
                            //家具
                            this.roleNode.active = false;
                            this.furnitureNode.active = true;
                            data = new FurnitureData_1.FurnitureData(dropData[0].dropId);
                            suit = new SuitData_1.SuitData(data.furnitureSuit);
                            ViewUtil_1.ViewUtil.setSingleSpriteFrame(this.furnitureNode, GameResPath_1.GameResPath.getSuitPreviewPath(suit.suitResShow.toString()), BundleConfig_1.default.instance.guiBundle.name);
                            _c.label = 3;
        ...
        Preview_1.prototype.onAdded = function (data) {
            this.data = data;
        };
        Preview_1.prototype.closeView = function () {
            Oops_1.oops.audio.playEffect(DataObject_1.AudioType.Sound_Click);
            Oops_1.oops.gui.remove(GameUIConfig_1.UIID.Preview);
        };
        return Preview_1;
    }(_classSuper));
