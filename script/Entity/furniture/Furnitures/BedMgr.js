...
var BedMgr = function () {
    ...
    var BedMgr = _classThis = /** @class */ (function (_super) {
        __extends(BedMgr_1, _super);
        function BedMgr_1() {
    ...
    __setFunctionName(_classThis, "BedMgr");
    (function () {
        var _a;
        ...
        BedMgr = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BedMgr = _classThis;
}();
exports.BedMgr = BedMgr;
