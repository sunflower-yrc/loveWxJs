...
var LightCP_1 = require("../../game/components/LightCP");
var HttpPost_1 = require("../../game/tools/HttpPost");
var ccclass = cc_1._decorator.ccclass, property = cc_1._decorator.property;
var MiniGameEnter = function () {
    var _classDecorators = [ccclass('MiniGameEnter')];
    ...
    var MiniGameEnter = _classThis = /** @class */ (function (_super) {
        __extends(MiniGameEnter_1, _super);
        function MiniGameEnter_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.light = (__runInitializers(_this, _instanceExtraInitializers), __runInitializers(_this, _light_initializers, null));
            return _this;
        }
        MiniGameEnter_1.prototype.onLoad = function () {
            GameMgr_1.GameMgr.Instance.miniGameNode = this.node;
            // this.node.on("click", )
        ...
        MiniGameEnter_1.prototype.onDestroy = function () {
        ...
        /**进入游戏机 */
        MiniGameEnter_1.prototype.btnEnterGameHome = function () {
            // () => {
        ...
        /**关闭按钮 */
        MiniGameEnter_1.prototype.offBtns = function () {
            // this.btn.enabled = false;
            // this.node.getComponentsInChildren(Button).forEach((btn) => {
            //     btn.enabled = false;
            // })
            this.node.parent.active = false;
        };
        /**关闭按钮 */
        MiniGameEnter_1.prototype.onBtns = function () {
        ...
        return MiniGameEnter_1;
    }(_classSuper));
    __setFunctionName(_classThis, "MiniGameEnter");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _light_decorators = [property(LightCP_1.LightCP)];
        ...
        MiniGameEnter = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MiniGameEnter = _classThis;
}();
exports.MiniGameEnter = MiniGameEnter;
