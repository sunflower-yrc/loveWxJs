...
var GuideViewComp_1 = require("./view/GuideViewComp");
/**
 * 新手引导
 ...
 */
var Guide = function () {
    var _classDecorators = [ECS_1.ecs.register('Guide')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = ECS_1.ecs.Entity;
    var Guide = _classThis = /** @class */ (function (_super) {
        __extends(Guide_1, _super);
        function Guide_1() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        Guide_1.prototype.init = function () {
            this.addComponents(GuideModelComp_1.GuideModelComp);
        };
        /** 加载引导资源 */
        Guide_1.prototype.load = function (callback) {
            ...
            // });
            // 注册显示对象到 ECS 实体中
            var gv = Oops_1.oops.gui.guide.addComponent(GuideViewComp_1.GuideViewComp);
            this.add(gv);
            callback();
        };
        /** 检查指定引导是否触发 */
        Guide_1.prototype.check = function (step) {
            if (this.GuideModel) {
                this.GuideModel.step = step;
                this.GuideView.check();
            }
        };
        Guide_1.prototype.destroy = function () {
            // oops.res.releaseDir(this.GuideModel.res_dir);
            this.remove(GuideViewComp_1.GuideViewComp);
            this.remove(GuideModelComp_1.GuideModelComp);
