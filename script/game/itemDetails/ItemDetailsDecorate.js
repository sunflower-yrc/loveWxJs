...
exports.ItemDetailsDecorate = void 0;
var cc_1 = require("cc");
...
var ItemDetailsDecorate = function () {
    var _classDecorators = [ccclass('ItemDetailsDecorate')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = ItemDetails_1.ItemDetails;
    var ItemDetailsDecorate = _classThis = /** @class */ (function (_super) {
        __extends(ItemDetailsDecorate_1, _super);
        function ItemDetailsDecorate_1() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        ItemDetailsDecorate_1.prototype.showInfo = function () {
            var _a;
        ...
        return ItemDetailsDecorate_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ItemDetailsDecorate");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ItemDetailsDecorate = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ItemDetailsDecorate = _classThis;
}();
exports.ItemDetailsDecorate = ItemDetailsDecorate;
