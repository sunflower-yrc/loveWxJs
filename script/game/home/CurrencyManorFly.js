...
exports.CurrencyManorFly = void 0;
var cc_1 = require("cc");
var cc_2 = require("cc");
var cc_3 = require("cc");
...
var CurrencyManorFly = function () {
    var _classDecorators = [ccclass('CurrencyManorFly')];
    ...
    var CurrencyManorFly = _classThis = /** @class */ (function (_super) {
        __extends(CurrencyManorFly_1, _super);
        function CurrencyManorFly_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.posNode = (__runInitializers(_this, _instanceExtraInitializers), __runInitializers(_this, _posNode_initializers, void 0));
            return _this;
        }
        CurrencyManorFly_1.prototype.start = function () {
            Oops_1.oops.gui.setPopUpNodeUnBlockEvent();
            this.fly();
        };
        CurrencyManorFly_1.prototype.fly = function () {
                        ...
                        case 0:
                            ...
                            _loop_1 = function (i) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, ViewUtil_1.ViewUtil.createPrefabNodeAsyncWithBundle(GameResPath_1.GameResPath.getManorCoinPrefabPath(), BundleConfig_1.default.instance.guiBundle.name)];
                                        case 1:
                                            coin = _b.sent();
                                            ...
                                            (0, cc_2.tween)(coin).
                                                ...
                                                count++;
                                                if (count >= 20) {
                                                    Oops_1.oops.gui.remove(GameUIConfig_1.UIID.CurrencyManorFly);
                                                }
                                            }).
                                                start();
                                            return [2 /*return*/];
        ...
        return CurrencyManorFly_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CurrencyManorFly");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _posNode_decorators = [property(cc_3.Node)];
        ...
        CurrencyManorFly = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CurrencyManorFly = _classThis;
}();
exports.CurrencyManorFly = CurrencyManorFly;
