...
var TTPlatform = /** @class */ (function () {
    ...
    TTPlatform.prototype.init = function (release, ver) {
        if (this.platform) {
    ...
    TTPlatform.prototype.getLoginCode = function () {
        if (this.platform) {
    ...
    //     })
    // }
    TTPlatform.prototype.getUserInfo = function (fromLogin) {
        if (this.platform) {
    ...
    TTPlatform.prototype.share = function (title, imageUrlId, imageUrl) {
        if (this.platform) {
    ...
    TTPlatform.prototype.shareMessage = function (title, imageUrlId, imageUrl, gameScene, query) {
        if (this.platform) {
    ...
    TTPlatform.prototype.createRewardedVideoAd = function (adType) {
        var _this = this;
        if (this.platform) {
            //转圈圈
    ...
    //     })
    // }
    TTPlatform.prototype.requestPayment = function (data) {
        var _this = this;
    ...
    //     })
    // }
    TTPlatform.prototype.requestMidasPayment = function (quantity) {
        if (this.platform) {
    ...
    TTPlatform.prototype.getExtraInfo = function () {
        if (this.platform) {
    ...
    TTPlatform.prototype.getSystemInfoSync = function () {
        if (this.platform) {
    ...
    TTPlatform.prototype.onShow = function (callback) {
        if (this.platform) {
            this.platform.onShow(callback);
        }
    };
    TTPlatform.prototype.onHide = function (callback) {
        if (this.platform) {
            this.platform.onHide(callback);
        }
    };
    TTPlatform.prototype.onMemoryWarning = function () {
        if (this.platform) {
    ...
    TTPlatform.prototype.triggerGC = function () {
        if (this.platform) {
            this.platform.triggerGC();
        }
    };
    TTPlatform.prototype.openCustomerServiceConversation = function () {
        if (this.platform) {
            this.platform.openCustomerServiceConversation();
        }
    };
    TTPlatform.prototype.showShareMenu = function () {
        if (this.platform) {
            this.platform.showShareMenu();
        }
    };
    TTPlatform.prototype.exitMiniProgram = function () {
        if (this.platform) {
            console.log("exit");
            this.platform.exitMiniProgram();
        }
    };
    TTPlatform.prototype.onShareTimeline = function (title, imageUrlId, imageUrl, query) {
        if (this.platform) {
            this.platform.onShareTimeline(title, imageUrlId, imageUrl, query);
        }
    };
    TTPlatform.prototype.reportRoleCreate = function (data) {
    };
    ...
    //     }
    // }
    TTPlatform.prototype.isShowPay = function (param) {
    ...
    //     })
    // }
    TTPlatform.prototype.createGameClub = function (callback) {
        if (this.platform) {
            this.platform.createGameClub(callback);
        }
    };
    TTPlatform.prototype.showGameClub = function (flag) {
        if (this.platform) {
            this.platform.showGameClub(flag);
        }
    };
    //事件上报
    TTPlatform.prototype.reportEvent = function (param) {
        if (this.wx) {
    ...
    Object.defineProperty(TTPlatform.prototype, "wx", {
        get: function () {
            return window['wx'];
        },
        enumerable: false,
